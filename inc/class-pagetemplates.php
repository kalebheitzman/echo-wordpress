 ...
 * PageTemplates Class
 *
 * Registers custom page templates for Project Echo. Adapted from
...
class PageTemplates {
	 ...
	 *
	 * @var instance Object PageTemplate Instance.
	 */
	 ...
	 *
	 * @var templates Array List of page templates.
	 */
	protected $templates;
	...
	private function __construct() {
		...
		$this->templates = array(
			'post-echo-event.php' => 'Project Echo Event',
		);
	 ...
	 *
	 * @param Array $posts_templates List of page templates.
	 */
